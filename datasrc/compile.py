...
if gen_network_header:
	...
	# TeeMo Weapons
	content.container.weapons.id.Add(WeaponSpec(content.container, "phantom_grenade"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "air_grenade"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "laser_grenade"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "dragon_grenade"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "extra_bomb_grenade"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "plasma_rifle"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "healer_rifle"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "repair_rifle"))
	content.container.weapons.id.Add(WeaponSpec(content.container, "turret"))
